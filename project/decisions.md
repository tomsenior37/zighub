...
| --- | --- | --- | --- |
| Working title / project name | **zighub** | 2026-05-17 | Free on npm registry as of decision date. UI title, binary name, npm package name. Repository renamed to `tomsenior37/zighub`. |
